...
def get_user_list(config, key):
    with open('{}/ShivaXProbot/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    OWNER_USERNAME = "Yuvi1poke_lover"
    SUPPORT_CHAT = 'ShivaSupportChat'  #Your own group for support, do not add the @
    UPDATES_CHANNEL = 'SHIVAUPDATES' #Your own channel for Updates of bot, Do not add @
    ...
    SPAMWATCH_SUPPORT_CHAT = "ShivaSupportChat"
    BOT_USERNAME = "Shiva_ProBot"
    BOT_ID = "2116046406"
