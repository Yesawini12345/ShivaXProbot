...
from ShivaXProbot.modules import ALL_MODULES
from ShivaXProbot.modules.helper_funcs.chat_status import is_user_admin
from ShivaXProbot.modules.helper_funcs.misc import paginate_modules
from ShivaXProbot.modules.disable import DisableAbleCommandHandler
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1610284626 and DONATION_LINK:
            update.effective_message.reply_text(
                "You can also donate to the person currentlyrunning me "
